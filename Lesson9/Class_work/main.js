...
// let simpsonUnpacking = array => {
//     for (let simpson of array) {
...
//                 simpsonItem.innerText = `${simpson[simpsonElement]}`
//                 simpsonDiv.append(simpsonItem)
//             } else {
//                 let simpsonItem = document.createElement('img')
//                 simpsonItem.src = `${simpson[simpsonElement]}`
//                 simpsonDiv.append(simpsonItem)
//             }
//
//         }
...
let stackTable = (array) => {
    for (let course of array) {
        ...
        monthDiv.innerText = `${course.monthDuration} month`
        timeDiv.append(monthDiv)

        let hourDiv = document.createElement('div')
        hourDiv.classList.add('hourDiv')
        hourDiv.innerText = `${course.hourDuration} hours`
        timeDiv.append(hourDiv)

        let listModules = document.createElement('ul')
        document.body.append(listModules)
        for (let module of course.modules) {
            let liModule = document.createElement('li')
            liModule.innerText = `${module}`
            listModules.append(liModule)
        }
    }
}
stackTable(coursesArray)